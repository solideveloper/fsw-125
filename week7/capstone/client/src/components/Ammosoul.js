    ...
    return (
        <div className= "list-container">
         { !editToggle ?
              ...
              <div>
                    ...
                    <img className="picture" src={image} alt="fruitpicture"/><br/>
                        mainfruit: {mainfruit}<br/>
                        sold in: {type ? "Glass" : "Plastic"} Jar <br/>
                        color: {color}<br/>
                        Price: ${price}
                    <br/>
                    <button onClick={() => 
                    ...
                    <button onClick={() => 
                        editFlavor(prevToggle => !prevToggle)} className="edit-btn"> Edit
                    </button>
        ...
        <>
            ...
            <button
                ...
                onClick={() => editFlavor(prevToggle => !prevToggle)}>
                Close
            </button>
            </>
        }
